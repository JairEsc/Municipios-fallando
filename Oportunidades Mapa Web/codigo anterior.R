##Mapa web oportunidades hidalgo. 
...
shape_oportunidades$C5[shape_oportunidades$C5=='Problemas sociales']='Problemas Sociales'
...
saveWidget(mapa_oportunidades,"Leaflet/Oportunidades_hidalgo/Oportunidades_Problemáticas_Hidalgo.html",selfcontained = T,title = "Oportunidades Hidalgo")
